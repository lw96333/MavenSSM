...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 租户管理 <span class="c-gray en">&gt;</span> 租户合约 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            <thead>
            <tr class="text-c">
                <th width="300px">合同编号</th>
                <th width="180px">联系人</th>
                <th width="220px">联系电话</th>
                <th width="220px">生效时间</th>
                <th width="220px">截止时间</th>
                <th width="200px">成交价格</th>
...
<script type="text/javascript" src="js/contract-list.js"></script>
