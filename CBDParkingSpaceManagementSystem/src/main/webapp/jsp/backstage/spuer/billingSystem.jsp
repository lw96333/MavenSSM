...
<body>
    ...
    <div class="page-container">
        <div class="">
                ...
                <button id="search" type="button" class="btn btn-success radius" ><i class="Hui-iconfont">&#xe665;</i> </button>
                <a title="合计" href="javascript:;" onclick="member_show('合计','jsp/backstage/spuer/billingSystemTotal.jsp','','500','480')" class="ml-5" style="text-decoration:none"><input value="账单合计" class="btn btn-success" style="width: 90px"/></a>
        </div>
        <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            <thead>
                <tr class="text-c">
                    <th width="220px">交易日期</th>
                    <th width="220px">交易时间</th>
                    <th width="200px">支出</th>
                    <th width="200px">收入</th>
                    <th width="400px">交易备注</th>
                </tr>
            </thead>
            <tbody id="show">
...
<script type="text/javascript" src="js/billingSystem.js"></script> 
</body>
</html>