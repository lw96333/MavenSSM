...
<article class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-member-add">
        ...
        <div class="row cl">
            ...
            <label id="xyd" class="form-label col-xs-4 col-sm-3"></label>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">价格：</label>
            <label id="pice" class="form-label col-xs-4 col-sm-3"></label>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">留言：</label>
            <!-- <label  class="form-label col-xs-4 col-sm-3"></label> -->
            <input type="text"  id="message" placeholder="留言"  style="width:200px" class="input-text">
        </div>
        <div class="row cl">
            <div class="col-xs-8 col-sm-5 col-xs-offset-3 col-sm-offset-3">
                <input class="btn btn-primary radius" id="lease" type="button" value="&nbsp;&nbsp;点击预订&nbsp;&nbsp;">
...
<script type="text/javascript" src="js/Lookdetails.js"></script>
</body>
</html>