...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页<span class="c-gray en">&gt;</span> 车位信息<span class="c-gray en">&gt;</span> 查看车位<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            <thead>
            <tr class="text-c">
                <th width="300">车位产全证编号</th>
                <th width="400">车位所在小区</th>
                <th width="200">状态</th>
                <th width="150">操作</th>
            </tr>
            </thead>
            <tbody id="showCarport">
...
<script type="text/javascript" src="js/ShowPersonageAddCarport.js"></script>
