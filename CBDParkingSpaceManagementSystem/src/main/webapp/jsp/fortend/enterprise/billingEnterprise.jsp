...
<body>
	...
	<div class="page-container">
	    <div class="">
	        ...
	        <button type="button" class="btn btn-success radius" id="search" name=""><i class="Hui-iconfont">&#xe665;</i> </button>
	        <a title="合计" href="javascript:;" onclick="member_show('合计','jsp/fortend/enterprise/billingEnterpriseTotal.jsp','','500','480')" class="ml-5" style="text-decoration:none"><input value="账单合计" class="btn btn-success" style="width: 90px"/></a>
	    </div>
	    <div class="mt-20">
...
<script type="text/javascript" src="js/BillingEnterprise.js"></script>
</body>
</html>