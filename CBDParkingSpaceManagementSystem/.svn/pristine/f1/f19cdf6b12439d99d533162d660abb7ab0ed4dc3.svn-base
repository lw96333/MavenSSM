...
<body>
    <nav class="breadcrumb" style="top: -23px"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 车位租赁<span class="c-gray en">&gt;</span> 查看空闲车位<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	<div class="page-container">
	    <div class="mt-20">
	        <table class="table table-border table-bordered table-hover table-bg table-sort">
	            <thead>
		            <tr class="text-c">
		                <th width="300">车位地址</th>
		                <th width="300">车位编号</th>
		                <th width="220">最长可租时间</th>
		            </tr>
	            </thead>
	            <tbody id="show">
...
<script type="text/javascript" src="js/LeisureTruckSpace-show.js"></script>
</body>
</html>