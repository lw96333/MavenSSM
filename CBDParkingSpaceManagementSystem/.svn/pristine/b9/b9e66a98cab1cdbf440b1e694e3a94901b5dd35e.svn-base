...
<body>
	<article class="page-container" style="margin-top: 80px">
	    <form action="" method="post" class="form form-horizontal" id="form-member-add">
	        ...
	        <div class="row cl col-md-offset-3">
	            <label class="form-label col-xs-4 col-sm-3">支出金额合计：</label>
	            <div class="formControls col-xs-8 col-sm-9">
	                <!--  <span id="countIncome"></span> -->
	                 <span id="countExpend" style="font-size: 20px"></span>
	        ...
	        <div class="row cl col-md-offset-3">
	            ...
	            <div class="formControls col-xs-8 col-sm-9">	                
	                <!-- <span id="countExpend"></span> -->
	                <span id="countIncome" style="font-size: 20px"></span>
                    &nbsp;&nbsp;<label style="font-size: 20px">元</label>
	            </div>
	        </div>
	        ...
	        <div class="row cl col-md-offset-3" style="margin-top: 30px">
	            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
	                <input class="btn btn-primary radius" type="button" value="&nbsp;&nbsp;确定&nbsp;&nbsp;" id="cheak">
	            </div>
	        </div>
	    </form>
	</article>
...
<script type="text/javascript" src="js/BillingEnterpriseTotal.js"></script>
</body>
</html>