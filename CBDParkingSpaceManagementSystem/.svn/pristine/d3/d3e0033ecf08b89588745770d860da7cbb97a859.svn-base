...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 合约管理 <span class="c-gray en">&gt;</span> 查看外部合约 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    <table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
				<th width="125px">合同号</th>
				<th width="335px">合同单位</th>
				<th width="110px">联系人</th>
				<th width="160px">联系人电话</th>
				<th width="185px">生效时间</th>
				<th width="185px">截止时间</th>
				<th width="120px">成交价格</th>
                <th width="75px">操作</th>
			</tr>
		</thead>
		<tbody id="bodyTr">
...
<script type="text/javascript" src="js/ViewExternalContracts.js"></script>
