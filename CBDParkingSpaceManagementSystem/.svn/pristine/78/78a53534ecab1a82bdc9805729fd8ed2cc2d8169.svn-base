...
<head>
    ...
    <title>审批个人买卖车位</title>
    
</head>
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 个人用户管理 <span class="c-gray en">&gt;</span> 审批个人买卖车位 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            <thead>
            <tr class="text-c">
                <th width="200px">车位产权证编号</th>
                <th width="350px">所在小区</th>
                <th width="180px">购买用户姓名</th>
                <th width="220px">电话号码</th>
                <th width="180px">出售用户姓名</th>
                <th width="220px">电话号码</th>
                <th width="280px">身份证号码</th>
...
<script type="text/javascript" src="js/ApprovalPersonBusinessParking.js"></script>
