$(function(){
	...
	function ajax(pageNum,userId){
		$.ajax({
			type : "post",
			url : "showHistoricalRentalParking",
			data : {
				"pageNum" : pageNum,
				"userId" : userId
    ...
    function member_complaint(obj,id){
        layer.confirm('投诉？',function(index){
            layer_show("投诉","jsp/fortend/personal/ComplaintInfo.jsp?id=1","350","250");
            $.ajax({
                type: 'POST',
                url: '',
                data:{
