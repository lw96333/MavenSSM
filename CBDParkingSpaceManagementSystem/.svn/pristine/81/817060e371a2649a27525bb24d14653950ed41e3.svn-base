    ...
    <form class="form form-horizontal" action="index.html" method="post">
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <input id="" name="userName" type="text" placeholder="账户" class="input-text size-L" maxlength="16">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-xs-8">
          <input id="" name="password" type="password" placeholder="密码" class="input-text size-L" maxlength="16">
        </div>
      </div>
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
            	<select id="type">
            		<option value="0">个人用户登录</option>
            		<option value="1">企业用户登录</option>
            	</select>
           ...
           <label for="online">
            <input type="checkbox" name="online" id="online" value=""> 记住我
           		<br/>
           		<a href="jsp/fortend/Enroll.jsp" id="res">注册账号</a>
            </label>
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;
          <input name="backLogin" type="reset" class="btn btn-default radius size-L" value="&nbsp;返&nbsp;&nbsp;&nbsp;&nbsp;回&nbsp;">
        </div>
      </div>
    </form>
  </div>
...
<!--此乃百度统计代码，请自行删除-->
<script type="text/javascript" src="js/FortendLogin.js"></script>
