...
/**
 * Servlet implementation class ShowUpdateIncidentServlet
 */
@WebServlet("/showUpdataIncident")
public class ShowUpdateIncidentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowUpdateIncidentServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(inciId != null){
			...
			request.getRequestDispatcher("jsp/update_incident_record.jsp").forward(request, response);
		}
