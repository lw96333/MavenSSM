...
public class CheckIncidentServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String inciId = request.getParameter("incidentId");
		if(inciId != null){
			...
			String str2 = "http://"+request.getHeader("Host")+File.separator +"img"+File.separator + incident.getPic();
			incident.setPic(str2);
