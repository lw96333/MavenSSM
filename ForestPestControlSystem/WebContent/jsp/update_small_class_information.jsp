...
<body>
			...
			<div id="main">
				<div id="content">
					...
					<div class="">
						<ol class="breadcrumb">
							<li><a href="#">灾情防治</a></li>
							<li class="active"><a href="smallClass">小班管理</a></li>
							<li class="active">修改小班信息</li>
						</ol>
					</div>

					<div class="panel panel-info col-md-10 col-md-offset-1">
						<div class="panel-heading">修改小班信息</div>
						<div class="panel-body">
							<form class="form-horizontal">
								<div class="form-group row">
									...
									<div class="col-md-5 col-md-offset-2">
										<input id="personName" type="text" class="form-control "
											maxlength="6" minlength="2" placeholder="负责人"
								...
								<div class="form-group row">
									...
									<div class="col-md-5">
										<input id="personPhone" type="text" class="form-control "
											maxlength="11" placeholder="名称"
	...
	<input id="smallClassId" value="${smallClass.id }" />
	<!-- end top -->
	<script src="js/jquery-1.7.2.min.js"></script>
	<script src="js/jquery-ui.js"></script>
	<script type='text/javascript' src='js/custom.js'></script>
	<script type='text/javascript' src="js/update_smallClass.js"></script>
</body>
