				...
				<div id="content">
					...
					<div class="panel panel-info col-md-10 col-md-offset-1">
						...
						<div class="panel-body">
							<form class="form-horizontal" enctype="multipart/form-data" action="../addPestsInfo"  method="post">
								<div class="form-group row">
									...
									<div class="col-md-5 ">
										<input type="text" class="form-control" name="pestsName"
											placeholder="虫害名称" maxlength="50">
									</div>
									<div class="col-md-5 col-md-offset-2">
										<input type="text" class="form-control" name="pestsHost"
											placeholder="寄主名称" maxlength="50">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-5">
										<textarea class="form-control" name="pestspreventiveMeasures"
											style="height: 150px; resize: none" maxlength="255"></textarea>
									</div>
...
<script language="javascript" type="text/javascript"
	src="../js/add_pestsbean.js"></script>
</body>
</html>