			...
			<div id="main">
				<div id="content">
					...
					<div class="panel panel-info col-md-10 col-md-offset-1">
						<div class="panel-heading">查看事件信息</div>
						<div class="panel-body">
							<form class="form-horizontal">
								...
								<div class="form-group row">
									...
									<div class="col-md-5">
										<span>${incident.controlMethod }</span>
									</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-5 col-md-offset-2">
										<span>${incident.stage.typeName }</span>
									</div>
								...
								<div class="form-group row">
									<div class="col-md-5 col-md-offset-5">
										<a  href="incident" class="btn btn-primary">返回</a>
									</div>
								</div>
