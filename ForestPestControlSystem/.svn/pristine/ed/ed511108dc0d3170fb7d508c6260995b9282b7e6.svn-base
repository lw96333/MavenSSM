 ...
 */
@WebServlet("/specialistcheckandupdate")
public class SpecialistCheckAndUpdateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SpecialistCheckAndUpdateServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("jsp/modifier_specialist.jsp").forward(request, response);
	}
