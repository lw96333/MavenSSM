...
public class IncidentPageServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(pageNum != null && pageSize != null){
			...
			PageBean<List<IncidentRecordBean>> page = inci.getAllIncidentRecord(Integer.parseInt(pageNum), Integer.parseInt(pageSize), incidentName, areaName,disasterStageType);
			Gson gson = new Gson();
