            ...
            <div id="content">
                ...
                <div class="">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">查看专家信息</li>
                    </ol>
                </div>

                <div  class="panel panel-info col-md-10 col-md-offset-1">
                    <div class="panel-heading">查看专家信息</div>
                    <div class="panel-body" >
                        <form class="form-horizontal">
                            ...
                            <div style="outline: 1px red solid;width: 72px;height: 105px;position: absolute;left: 510px;top:70px">
                                <img src="${specialist.pic}" style="width:72px;height:105px">
                            </div>
                            <div class="form-group row">
...
<script type='text/javascript' src='js/check_specialist.js'></script>
</body>
