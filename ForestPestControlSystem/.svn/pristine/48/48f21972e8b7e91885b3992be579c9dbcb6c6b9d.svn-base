			...
			<div id="main">
				<div id="content">
					...
					<div class="">
						<ol class="breadcrumb">
							<li><a href="#">灾情防治</a></li>
							<li class="active"><a href="../smallClass">区域一览</a></li>
							...
							<form class="form-horizontal">
								<div class="form-group row">
									...
									<div class="col-md-6 col-md-offset-3">
										<input type="text" id="smallClassName" class="form-control " maxlength="10" 
											placeholder="名称">
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-md-6 col-md-offset-3">
										<input type="text" id="personName" class="form-control " maxlength="6" minlength="2" 
											placeholder="负责人">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-6 col-md-offset-3">
										<input type="text" id="personPhone" class="form-control " maxlength="11"
											placeholder="负责人电话">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-6 col-md-offset-3">
										<input type="text" id="personNum" class="form-control " maxlength="2"
											placeholder="人员数量">
									</div>
								</div>
