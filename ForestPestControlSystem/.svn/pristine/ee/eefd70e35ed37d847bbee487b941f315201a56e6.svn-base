...
<body>
    ...
    <body>
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" >
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                <input onkeyup="value=value.replace(/[^0-9\u4E00-\u9FA5]/g,'')" type="text" class="form-control" name="pageName"id="pageName" placeholder="只能输入中文、数字">
                                            </div>
                                             <label for="inputEmail3" >防止类型</label>
                                            <div class="">
                                                <input onkeyup="value=value.replace(/[^\u4E00-\u9FA5]/g,'')" type="text" class="form-control" name="pageInsect" id="pageInsect" placeholder="只能输入中文">
                                            </div>
                                        </div>
                                        <div class="form-group">
		...
		<script src="js/consultation_management.js"></script>
