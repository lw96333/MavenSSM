							...
							<form class="form-horizontal" action="../addUserBeanInfo" method="post">
								<div class="form-group row">
									...
									<div class="col-md-6 col-md-offset-3">
										<input type="text" class="form-control " name = "userName"maxlength="16"placeholder="用户名">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-6 col-md-offset-3">
										<input type="password" class="form-control "name="userPass1" maxlength="100" placeholder="密码">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-6 col-md-offset-3">
										<input type="password" class="form-control "maxlength="100" name ="userPass2"placeholder="确认密码">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-6 col-md-offset-3">
										<input type="text" class="form-control "name="trueName" maxlength="30" placeholder="真实姓名">
									</div>
								</div>
