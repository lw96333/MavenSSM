...
<header class="am-topbar am-topbar-fixed-top">
	...
	<div class="contain">
		<ul class="am-nav am-navbar-nav am-navbar-left">
			...
			<li><h4 class="page-title">我的车位&nbsp;&nbsp;>>&nbsp;&nbsp;添加出售信息</h4></li>
		</ul>
						...
						<table>
							...
							<tr style="text-align: left;">
								<td style="line-height: 50px; padding-left: 150px;">
									...
									<a href="parking_space_purchase.jsp" class="btn btn-info" role="button">发布</a> <a href="table_basic.jsp" class="btn btn-info" role="button">返回</a>
								</td>
