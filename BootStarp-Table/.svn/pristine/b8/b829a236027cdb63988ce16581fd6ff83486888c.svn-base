...
<div class="admin">
  ...
  <div class="content-page">
    ...
    <div class="content">
      ...
      <div class="card-box">
        <a href="table_complete1.jsp" class="btn btn-info" role="button">我的车位</a>
        <div class="am-g">
          <!--=====================表格和按钮格式==============-->
            ...
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
                <table class="table table-hover">
                  <thead>
                  <tr>
                    <th class="table-title">用户名</th><th class="table-author am-hide-sm-only">待租车位信息</th><th class="table-author am-hide-sm-only">租借开始时间</th><th class="table-date am-hide-sm-only">租借结束时间</th><th class="table-date am-hide-sm-only">职业</th><th class="table-date am-hide-sm-only">信誉度</th><th class="table-title">出租价格</th><th class="table-set">操作</th>
                  ...
                  <tr>
                    ...
                    <td>100%</td>
                    <td>280元/月</td>
                    <td><a href="view_details.jsp" class="btn btn-info" role="button">查看</a><a href="message_board.jsp" class="btn btn-info" role="button">预定</a></td>
