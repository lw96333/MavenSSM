    ...
    <div class="content-page">
        ...
        <div class="content">
            ...
            <div class="card-box">
                ...
                <div class="am-g" style="margin-left: 30%;">
                    <h4 class="page-title">网上签约合同如下：</h4>
                    <P>合同编号：XXXX-XXXX-XXXXX</P>
                    <P>车位出售方个人信息：
                        ...
                        <table>
                            ...
                            <tr style="text-align: left;">
                                <td style="line-height: 50px; padding-left: 150px;">
                                    ...
                                    用户名：<lable id="date">sdas</lable><br>
                                    真实名：<lable id="date">asda</lable><br>
                                    身份证号:<lable id="date">456165156</lable><br>
                                    电话号码:<lable id="date">5615616</lable><br>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <table>
                            ...
                            <tr style="text-align: left;">
                                <td style="line-height: 50px; padding-left: 150px;">
                                    ...
                                    用户名：<lable id="date">asdasd</lable><br>
                                    真实名：<lable id="date">asda</lable><br>
                                    身份证号:<lable id="date">651561651</lable><br>
                                    电话号码:<lable id="date">65161</lable><br>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <P>车位信息：<br><br>
                        车位地址：<lable id="date">sadasdas</lable><br>
                        车位产权证编号：<lable id="date">asdasd</lable><br>
                    </P>
                    <P>交易价格：<lable id="date">15161616</lable></P>

                    <a href="view_details_purchase.jsp" class="btn btn-info" role="button">同意</a><a href="view_details_purchase.jsp" class="btn btn-info" role="button" style="margin-left: 210px;">拒绝</a>
