		...
		<header class="am-topbar am-topbar-fixed-top">		
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title">资料修改</h4></li>
				</ul>
						...
						<div class="card-box">
							...
							<form class="am-form am-form-horizontal" >
								<div class="am-form-group">
									<label for="" class="am-u-sm-3 am-form-label am-text-right am-padding-right-0">企业登陆名</label>
									<div class="am-u-sm-9">
										<input type="text" value="fusengmeicompany" disabled/>
									</div>
								</div>
								
								<div class="am-form-group">
									<label for="" class="am-u-sm-3 am-form-label am-text-right am-padding-right-0">公司名称</label>
									<div class="am-u-sm-9">
										<input type="text" value="富森美有限公司" disabled/>
									</div>
								</div>
								<div class="am-form-group">
									<label for="" class="am-u-sm-3 am-form-label am-text-right am-padding-right-0">公司楼层</label>
									<div class="am-u-sm-9">
										<input type="text" value="CBD商务楼A区1201" disabled/>
									</div>
								</div>
								<div class="am-form-group">
									<label for="" class="am-u-sm-3 am-form-label am-text-right am-padding-right-0">企业联系人</label>
									<div class="am-u-sm-9">
								...
								<div class="am-form-group">
									<div class="am-u-sm-10 am-u-sm-offset-3" style="padding-left: 200px"><br/><br/>
										<a href="../index.html"> <button type="button" class="btn btn-info" style="width: 300px">确认修改</button>
										</a>
									</div>
								</div>
							</form>
