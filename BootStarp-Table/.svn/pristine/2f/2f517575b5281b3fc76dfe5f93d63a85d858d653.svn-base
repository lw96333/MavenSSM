            ...
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
                <table class="table table-hover">
                  <thead>
                  <tr>
                    <th class="table-title">用户名</th><th class="table-author am-hide-sm-only">待售车位信息</th><th class="table-title">真实名</th><th class="table-date am-hide-sm-only">身份证号</th><th class="table-date am-hide-sm-only">职业</th><th class="table-date am-hide-sm-only">信誉度</th><th class="table-title">出售价格</th><th class="table-set">操作</th>
                  ...
                  <tr>
                    ...
                    <td>刘一杨</td>
                    <td>511025198419228412</td>
                    <td>自由职业者</td>
                    <td>100%</td>
                    <td>100000元/月</td>
                    <td><a href="view_details_purchase.jsp" class="btn btn-info" role="button">查看</a><a href="message_board_purchase.jsp" class="btn btn-info" role="button">预定</a></td>
