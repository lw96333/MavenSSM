            ...
            <div class="am-g">
                ...
                <div class="bs-example" data-example-id="hoverable-table">
                    <div class="card-box"style="padding-right: 200px">
                        <h4 class="header-title m-t-0 m-b-30">招租交易记录详情</h4>
                        <form class="am-form am-form-horizontal">

                            <div class="am-form-group">
                                <label for="doc-ipt-pwd-2" class="am-u-sm-3 am-form-label am-text-right am-padding-right-0">租赁者：</label>
                                <div class="am-u-sm-9">
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-10 am-u-sm-offset-3" style="padding-left: 50px">
                                    <a href="rendOwnerTransactionRecord.jsp">  <button type="button" class="btn btn-info" style="width: 200px">确定</button>
                                    </a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
