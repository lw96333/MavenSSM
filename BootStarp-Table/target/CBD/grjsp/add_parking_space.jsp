...
<header class="am-topbar am-topbar-fixed-top">
	...
	<div class="contain">
		<ul class="am-nav am-navbar-nav am-navbar-left">
			...
			<li><h4 class="page-title">我的车位&nbsp;&nbsp;>>&nbsp;&nbsp;添加车位信息</h4></li>
		</ul>
						...
						<table>
							...
							<tr style="text-align: left;">
								<td style="line-height: 50px; padding-left: 150px;">
									...
									车位地址：<lable id="date"><input type="text" class="form-control" id="exampl" placeholder=""></lable><br>
									车位区域：<lable id="date"><input type="text" class="form-control" id="el" placeholder=""></lable><br>
									车位编号:<lable id="date"><input type="text" class="form-control" id="examl" placeholder=""></lable><br>

									<a href="table_basic.jsp" class="btn btn-info" role="button">添加</a>
								</td>
								<td style="padding-left: 150px; line-height: 50px">产权图片:<input type="file"><br>
									车位产权编号:<lable id="date"><input type="text" class="form-control" id="empl" placeholder=""></lable><br>

									车位状态:<lable id="date"><input type="text" class="form-control" id="exmpl" placeholder=""></lable><br>
									<a href="table_basic.jsp" class="btn btn-info" role="button">返回</a>
								</td>
							</tr>
							</tbody>
						</table>
