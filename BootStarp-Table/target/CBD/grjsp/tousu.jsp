                ...
                <div class="am-g">
                    ...
                    <div class="bs-example" data-example-id="hoverable-table">
                        <table class="table table-hover">
                            <thead>
                            <tr>
                                <th class="table-id">ID</th><th class="table-title">投诉者</th><th class="table-type">被投诉者</th><th class="table-author am-hide-sm-only">投诉内容</th><th class="table-date am-hide-sm-only">投诉日期</th><th class="table-set">投诉状态</th><th class="table-set">投诉结果</th><th class="table-set">操作</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <td scope="row" >1</td>
                                <td><a href="#" data-toggle="modal" data-target="#myModal" >张山</a></td>
                                <td class="am-hide-sm-only">王小二</td>
                                <td class="am-hide-sm-only"  style="max-width: 50px;overflow: hidden; text-overflow:ellipsis;white-space: nowrap" >
                                    <a href="#" data-toggle="modal" data-target="#myModal" > Business management111111111111111111111111111111111111111111111111111111</a></td>
                                <td class="am-hide-sm-only">2014年9月4日 7:28:47</td>
                                <td class="am-hide-sm-only" style="color: lawngreen">已处理</td>
                                <td class="am-hide-sm-only" style="color: lawngreen">成功</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="am-hide-sm-only"  style="max-width: 50px;overflow: hidden; text-overflow:ellipsis;white-space: nowrap" >
                                    <a href="#" data-toggle="modal" data-target="#myModal" > Business management111111111111111111111111111111111111111111111111111111</a></td>
                                <td class="am-hide-sm-only">2014年9月4日 7:28:47</td>
                                <td class="am-hide-sm-only" style="color: red">未处理</td>
                                <td class="am-hide-sm-only" style="color: red">未处理</td>
                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                            ...
                            <tr>
                                ...
                                <td class="am-hide-sm-only">2014年9月4日 7:28:47</td>
                                <td class="am-hide-sm-only" style="color: lawngreen">已处理</td>
                                <td class="am-hide-sm-only" style="color: red">失败</td>
                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <button type="button"  class="btn btn-info" data-toggle="modal" data-target="#myModal" > 查看</button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">投诉详细信息</h4>
                </div>
                <div  style="width: 600px;  height: 450px;">
                    ...
                    <div style="width: 500px;height: 500px;position: absolute;">
                        ...
                        <div style="position: relative;left: 40px;top: 20px" >
                            <label>投诉者：</label><label>张三</label>
                        </div>
                        ...
                        <br/>
                        <label style="position: relative;left: 40px;" >投诉内容：</label>
                        <div class="modal-body">
                            <label style="position: relative;left: 100px;width: 80%;height: 150px;">One fine body&hellip;</label>
                        </div>
                        <label style="position: relative;left: 40px;" >投诉时间：2019.1.22  12:15:33</label>

                        <div style="position: relative;left: 325px;top: -32px" >
                            <label >投诉状态：</label> <label>以处理</label>
                        </div>

                        <div  style="position: relative;left: 325px;top: -10px">
                            <label >投诉结果：</label> <label>成功</label>
