...
<div class="admin">
	...
	<div class="content-page">
		...
		<div class="content">
			...
			<div class="card-box">
				<a href="add_parking_space.jsp" class="btn btn-info" role="button">添加</a>
				<div class="am-g">
					<!--=====================表格和按钮格式==============-->
						...
						<table class="am-table am-table-striped am-table-hover table-main">
							...
							<tr>
								<table class="table table-hover">
									<thead>
									<tr>
										<th class="table-title">车位地址</th><th class="table-type">车位区域</th><th class="table-author am-hide-sm-only">车位编号</th><th class="table-date am-hide-sm-only">车位产权编号</th><th class="table-date am-hide-sm-only">产权图片</th><th class="table-date am-hide-sm-only">车位状态</th><th class="table-set">操作</th>
									...
									<tr>
										...
										<td>中海兰亭小区</td>
										<td>E023</td>
										<td>safdsfsddfsdxg</td>
										<td>avatar-1.jpg</td>
										<td>空闲</td>
										<td><a href="add_parking_space1.jsp" class="btn btn-info" role="button">出租</a><a href="add_parkingspacepurchase.jsp" class="btn btn-info" role="button">出售</a></td>
									...
									<tr>
										...
										<td>avatar-1.jpg</td>
										<td>空闲</td>
										<td><a href="add_parking_space1.jsp" class="btn btn-info" role="button">出租</a><a href="view_details.jsp" class="btn btn-info" role="button">出售</a></td>
									</tr>
									</tbody>
								</table>
							</tr>
