                    ...
                    <div class="card-box">
                        <table class="am-table  am-table-striped" >
                            ...
                            <tr>
                                ...
                                <td>已售</td>
                                <td>2015-12-25</td>
                                <td><a href="lookSellJransactionRecord.jsp"><button type="button" class="btn btn-info">查看详细信息</button></a>
                                </td>
                            </tr>
                            <tr>
                                <td>Amaze UI</td>
                                ...
                                <td>已售</td>
                                <td>2015-12-25</td>
                                <td><a href="lookSellJransactionRecord.jsp"><button type="button" class="btn btn-info">查看详细信息</button></a>                                </td>
                            </tr><tr>
                                <td>Amaze UI</td>
                                <td>海澜庭小区</td>
                                <td>东边</td>
