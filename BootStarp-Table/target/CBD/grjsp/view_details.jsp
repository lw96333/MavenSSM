...
<header class="am-topbar am-topbar-fixed-top">
	...
	<div class="contain">
		<ul class="am-nav am-navbar-nav am-navbar-left">
			...
			<li><h4 class="page-title">我的车位&nbsp;&nbsp;>>&nbsp;&nbsp;详细信息</h4></li>
		</ul>
						...
						<table>
							...
							<tr style="text-align: left;">
								<td style="line-height: 50px; padding-left: 150px;">
									...
									车位地址：<lable id="date">成都市天府一街12号</lable><br>
									车位区域：<lable id="date">中海兰亭小区</lable><br>
									车位编号:<lable id="area">	E023</lable><br>
									车位产权编号:<lable id="area">safdsfsddfsdxg</lable><br>
								</td>
								<td style="padding-left: 150px; line-height: 50px">产权图片<img src="../assets/img/avatar-1.jpg" alt="" style="width: 150px; height: 150px" id="imgs"><br>

									车位状态:<lable id="area">空闲</lable><br>
