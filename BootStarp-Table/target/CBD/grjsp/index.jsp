					...
					<div id="myCarousel" class="carousel slide">
						...
						<div class="carousel-inner">
							<div class="item active">
								<img src="../assets/img/back.jpg" alt="First slide" style="height: 496px; width: 1200px;">
							</div>
							<div class="item">
								<img src="../assets/img/bg1.jpg" alt="Second slide" style="height: 496px; width: 1200px;">
							</div>
							<div class="item">
								<img src="../assets/img/123.jpg" alt="Third slide" style="height: 496px; width: 1200px;">
							</div>
						</div>
						<!-- 轮播（Carousel）导航 -->
